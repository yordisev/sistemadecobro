...
$query = mysqli_query($conn, "SELECT SUM(recibido) sumatotaldiaria
FROM db_cuotas_pagadas
WHERE estado = 'pagada'
and DATE_FORMAT(fecha_pago, '%Y-%m-%d') = CURDATE()")
      ...
      <div class="box box-success">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3>$ <?php echo number_format($data1['sumatotaldiaria']); ?></h3>
